...
if (isset($_POST['loginUser'])) {
    //@todo appeler une méthode verifyUserLoginPassword qui retourne false ou retourne un tableau avec l'utisateur  OK
    ...
    if ($user) {
        ...
        if($user['role'] === "admin") //si utilisateur est admin, on redirige vers admin -> index.php
        {
            header('Location: ./admin/index.php');
        }
        else
        {
            header('Location: index.php'); //sinon vers la page d'accueil
        }
    }
    ...
    /* @todo si on récupère un utilisateur, alors on stocke l'utilisateur dans la session ========= OK
